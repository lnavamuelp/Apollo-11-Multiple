...
public class Control_Apollo_11_Multiples_Hilos {
    ...
    public Control_Apollo_11_Multiples_Hilos() {
...
// Configuración de acciones para los botones de Iniciar y Detener Cuenta Atras.
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new Control_Apollo_11_Multiples_Hilos().rootPanel);
